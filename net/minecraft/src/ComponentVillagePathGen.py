...
#     {
#         for(int i1 = 7 * MathHelper.func_35476_a(random, 3, 5); i1 >= 7; i1 -= 7)
#         {
#             StructureBoundingBox structureboundingbox = StructureBoundingBox.func_35663_a(i, j, k, 0, 0, 0, 3, 3, i1, l);
