...
#     }
# 
#     protected Item func_40223_b(String s)
#     {
#         field_39006_bR = s;
#         return this;
#     }
...
#         gunpowder = (new Item(33)).setIconCoord(8, 2).setItemName("sulphur").func_40223_b(PotionHelper.field_40568_k);
...
#         appleGold = (new ItemAppleGold(66, 10, 1.2F, false)).func_35423_n().setPotionEffect(Potion.regenerationPotion.potionId, 30, 0, 1.0F).setIconCoord(11, 0).setItemName("appleGold");
...
#         redstone = (new ItemRedstone(75)).setIconCoord(8, 3).setItemName("redstone").func_40223_b(PotionHelper.field_40570_i);
...
#         lightStoneDust = (new Item(92)).setIconCoord(9, 4).setItemName("yellowDust").func_40223_b(PotionHelper.field_40567_j);
#         sugar = (new Item(97)).setIconCoord(13, 0).setItemName("sugar").func_40223_b(PotionHelper.field_40560_b);
...
#         chickenRaw = (new ItemFood(109, 2, 0.3F, true)).setPotionEffect(Potion.hungerPotion.potionId, 30, 0, 0.3F).setIconCoord(9, 7).setItemName("chickenRaw");
#         rottenFlesh = (new ItemFood(111, 4, 0.1F, true)).setPotionEffect(Potion.hungerPotion.potionId, 30, 0, 0.8F).setIconCoord(11, 5).setItemName("rottenFlesh");
#         ghastTear = (new Item(114)).setIconCoord(11, 7).setItemName("ghastTear").func_40223_b(PotionHelper.field_40561_c);
#         netherStalkSeeds = (new ItemSeeds(116, Block.netherStalk.blockID, Block.slowSand.blockID)).setIconCoord(13, 7).setItemName("netherStalkSeeds").func_40223_b("+4");
#         spiderEye = (new ItemFood(119, 2, 0.8F, false)).setPotionEffect(Potion.poisonPotion.potionId, 5, 0, 1.0F).setIconCoord(11, 8).setItemName("spiderEye").func_40223_b(PotionHelper.field_40558_d);
#         fermentedSpiderEye = (new Item(120)).setIconCoord(10, 8).setItemName("fermentedSpiderEye").func_40223_b(PotionHelper.field_40559_e);
#         blazePowder = (new Item(121)).setIconCoord(13, 9).setItemName("blazePowder").func_40223_b(PotionHelper.field_40557_g);
#         magmaCream = (new Item(122)).setIconCoord(13, 10).setItemName("magmaCream").func_40223_b(PotionHelper.field_40569_h);
...
#         speckledMelon = (new Item(126)).setIconCoord(9, 8).setItemName("speckledMelon").func_40223_b(PotionHelper.field_40556_f);
#         StatList.initStats();
#     }
# }
